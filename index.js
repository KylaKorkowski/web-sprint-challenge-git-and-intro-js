...
function listOfNames(array) {
  ...
  for(let i = 0; i < artName.length; i++) {
    newArr.push(artName[i].name);
  }
  return newArr;
}
...
console.log(addArtist(artists, 'Kyla', '2003 - Present Day', "Web Development", "American", "I live in Hawaii and I have a cute dog!"));
